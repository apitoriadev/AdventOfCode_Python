...
lines: List[str] = open("C:\\Users\\laura.velez\\source\\repos\\AdventOfCode_Python\\day03\\sourcefile.txt").read().splitlines()
# lines: List[str] = open("C:\\Users\\laura.velez\\source\\repos\\AdventOfCode_Python\\day03\\training.txt").read().splitlines()
